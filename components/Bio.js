import { About, Blurb, AboutContent, Rex, Texture } from "./styles";
      ...
      <Texture>
        <AboutContent>
          <Blurb>
            ...
            <p>
              Below is a small sample of my work. All examples were taken from
              PSD to code. Technology used include React/Redux, HTML, CSS, PHP,
              and Magento.
            </p>
          </Blurb>
        </AboutContent>
